  ...
  <div class="mod-org">
    <el-form :inline="true" :model="searchForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('base:org:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button v-if="isAuth('base:org:update')" type="text" size="small"
                     @click="addOrUpdateHandle(scope.row.orgNo)">
            修改
          </el-button>
          <el-button v-if="isAuth('base:org:remove')" type="text" size="small" @click="deleteHandle(scope.row.orgNo)">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
