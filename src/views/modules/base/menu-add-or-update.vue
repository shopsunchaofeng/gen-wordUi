      ...
      init (id) {
        ...
        this.$http({
          ...
          if (!this.dataForm.id) {
            ...
            // 修改
            this.$http({
              url: `/base/menu/info/${this.dataForm.id}`,
              method: 'get'
            }).then(({data}) => {
              const menu = data.data
              this.dataForm.id = menu.menuId
              this.dataForm.type = menu.type
              this.dataForm.name = menu.name
              this.dataForm.parentId = menu.parentId
              this.dataForm.url = menu.url
              this.dataForm.perms = menu.perms
              this.dataForm.orderNum = menu.orderNum
              this.dataForm.icon = menu.icon
