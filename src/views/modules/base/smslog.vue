  ...
  <div class="mod-smslog">
    <el-form :inline="true" :model="searchForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('base:smslog:config')" type="primary" @click="addConfig()">短信配置</el-button>
        <el-button v-if="isAuth('base:smslog:send')" type="success" @click="sendSms()">发送短信</el-button>
        <el-button v-if="isAuth('base:smslog:remove')" type="danger" @click="deleteHandle()"
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button v-if="isAuth('base:smslog:remove')" type="text" size="small" @click="deleteHandle(scope.row.id)">
            删除
          </el-button>
        </template>
      </el-table-column>
