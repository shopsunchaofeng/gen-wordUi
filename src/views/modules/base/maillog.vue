  ...
  <div class="mod-maillog">
    <el-form :inline="true" :model="searchForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('base:maillog:config')" type="primary" @click="configHandle()">邮箱配置
        </el-button>
        <el-button v-if="isAuth('base:maillog:remove')" type="danger" @click="deleteHandle()"
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="isAuth('base:maillog:remove')" type="text" size="small" @click="deleteHandle(scope.row.id)">
            删除
          </el-button>
        </template>
      </el-table-column>
