  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item label="" prop="personId">
        <el-input v-model="dataForm.personId" placeholder=""></el-input>
      </el-form-item>
      <el-form-item label="图片URL" prop="url">
        <el-input v-model="dataForm.url" placeholder="图片URL"></el-input>
      </el-form-item>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: `/id/commentimage/info/${this.dataForm.id}`,
              method: 'get'
            }).then(({data}) => {
