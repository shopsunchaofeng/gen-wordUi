<template>
  <el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible" :fullscreen="true" :close-on-press-escape="false">
    <el-form :model="dataForm" :rules="dataRule" ref="tableForm" @keyup.enter.native="dataFormSubmit()" label-width="300px" label-position="left" size="medium">
      <el-row :gutter="40">
        <el-col :span="12">
        ...
        <el-col :span="12">
          <div class="grid-content">
            <el-form-item label="投入运行日期" prop="tourudate">
              <el-date-picker v-model="dataForm.tourudate" type="date" value-format="yyyy 年 M 月 d 日" placeholder="请选择投入运行日期"></el-date-picker>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
        ...
        <el-col :span="24">
          <div class="grid-content">
            <el-form-item label="业务概述" prop="yewugaishu">
              <el-input type="textarea" v-model="dataForm.yewugaishu" :rows="2" placeholder="请填写业务概述（200字）" maxlength="200" show-word-limit></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
        ...
        <el-col :span="24">
          <div class="grid-content">
            <el-form-item label="上传网络拓扑图(最多上传一张)" prop="tuoputu">
              <el-upload :action="upPicUrl" list-type="picture-card" :limit="1" :file-list="tuputuList" :on-preview="handlePictureCardPreview" :on-remove="handleRemove" :on-success="upimgok" :auto-upload="true" ref="upload">
        ...
        <el-col :span="24">
          <div class="grid-content">
            <el-form-item label="拓扑结构描述" prop="tuoputumaioshu">
              <el-input type="textarea" v-model="dataForm.tuoputumaioshu" :rows="2" placeholder="请填写拓扑结构描述（200字）" maxlength="200" show-word-limit></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
        ...
        <el-col :span="24">
          <div class="grid-content">
            <el-form-item label="业务信息描述（请按照提示词补充填写）" prop="yewuimaioshu">
              <el-input type="textarea" v-model="dataForm.yewuimaioshu" :rows="2" placeholder="该信息系统包含的业务信息有xxx条，其中信息量约2.5G（Mysql数据形式）；包含文件信息约20G；（请按照提示词补充填写）"></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
        ...
        <el-col :span="24">
          <div class="grid-content">
            <el-form-item label="系统服务描述（请按照提示词补充填写）" prop="xitongmiaoshu">
              <el-input type="textarea" v-model="dataForm.xitongmiaoshu" :rows="2" placeholder="该信息系统 提供的系统服务包含的 用户数据约为10万条（请按照提示词补充填写）"></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
            ...
            <el-table :data="dataForm.gjcpsyqkdata" style="width: 100%" :key="Math.random()">
              ...
              <el-table-column align="center" prop="num" label="数量" width="300px">
                <template slot-scope="scope" width="100px">
                  <el-form-item :prop="'gjcpsyqkdata.'+scope.$index + '.num'" :rules="dataRule.num" label-width="1px">
              ...
              <el-table-column align="center" label="使用国产品率">
                <template slot-scope="scope">
                  <el-form-item :prop="'gjcpsyqkdata.'+scope.$index + '.checkissy'" :rules="dataRule.checkissy" label-width="1px">
                  ...
                  <el-form-item :prop="'gjcpsyqkdata.'+scope.$index + '.syl'" :rules="dataRule.syl" label-width="1px" v-if="scope.row.checkissy==scope.row.issy[2]">
          ...
          <div class="grid-content">
            ...
            <el-table :data="dataForm.fwqkdata" style="width: 100%" :key="Math.random()">
              ...
              <el-table-column align="center" label="服务类型" width="300px">
                <template slot-scope="scope">
                  <el-form-item :prop="'fwqkdata.'+scope.$index + '.checkisok'" :rules="dataRule.checkisok" label-width="1px" v-if="scope.$index!=dataForm.fwqkdata.length-1">
              ...
              <el-table-column align="center" label="服务责任方类型">
                <template slot-scope="scope">
                  <el-form-item :prop="'fwqkdata.'+scope.$index + '.checkzrftype'" :rules="dataRule.checkzrftype" label-width="1px">
          ...
          <div class="grid-content">
            <el-form-item label="信息系统类别" prop="msgType">
              <el-radio-group v-model="dataForm.msgType">
                <el-radio :label="item.value" v-for="(item, index) in msgTypeList" :key="index" border>{{item.name}}</el-radio>
              </el-radio-group>
            </el-form-item>
          </div>
        </el-col>
        ...
        <el-col :span="12">
          <div class="grid-content">
            <el-form-item label="定级时间" prop="dingjidate">
              <el-date-picker v-model="dataForm.dingjidate" type="date" value-format="yyyy 年 M 月 d 日" placeholder="请选择定级时间"></el-date-picker>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
        ...
        <el-col :span="12">
          <div class="grid-content">
            <el-form-item label="填表日期" prop="tianbiaodate">
              <el-date-picker v-model="dataForm.tianbiaodate" type="date" value-format="yyyy 年 M 月 d 日" placeholder="请选择填表日期"></el-date-picker>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="40" v-show="dataForm.isxtdjbg=='59c'">
        <el-col :span="12">
          <div class="grid-content">
      ...
      <div v-show="dataForm.bmMsgType1=='50c'">
        ...
        <el-row :gutter="40" v-show="dataForm.f01=='61c'">
          <el-col :span="12">
            <div class="grid-content">
        ...
        <el-row :gutter="40" v-show="dataForm.f02=='63c'">
          <el-col :span="12">
            <div class="grid-content">
        ...
        <el-row :gutter="40" v-show="dataForm.f03=='65c'">
          <el-col :span="12">
            <div class="grid-content">
        ...
        <el-row :gutter="40" v-show="dataForm.f04=='67c'">
          <el-col :span="12">
            <div class="grid-content">
        ...
        <el-row :gutter="40" v-show="dataForm.f05=='69c'">
          <el-col :span="12">
            <div class="grid-content">
        ...
        <el-row :gutter="40" v-show="dataForm.f06=='71c'">
          <el-col :span="12">
            <div class="grid-content">
        ...
        <el-row :gutter="40" v-show="dataForm.f07=='73c'">
          <el-col :span="12">
            <div class="grid-content">
...
<script>
import jsonData from '@/utils/profession.json'
export default {
  data() {
