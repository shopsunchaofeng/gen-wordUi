<template>
  <el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible" :close-on-press-escape="false" :fullscreen="true">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="160px" label-position="left" size="medium">
      <el-row :gutter="40">
        <el-col :span="12">
        ...
        <el-col :span="12">
          <div class="grid-content">
            <el-form-item label="单位地址" prop="danweiaddress">
              <el-cascader size="medium" :options="options" v-model="dataForm.danweiaddress" @change="handleChange" separator=" "></el-cascader>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
