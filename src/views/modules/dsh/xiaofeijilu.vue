      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-tag v-if="scope.row.category === 1" v-text="-scope.row.jifen+'积分'"></el-tag>
            <el-tag v-if="scope.row.category === 2" v-text="-scope.row.totalprice+'元'"></el-tag>
          </template>
        </el-table-column>
        <el-table-column
          prop="fukuantime"
