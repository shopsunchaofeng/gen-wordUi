    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      <el-tabs tab-position="left" >
        <el-tab-pane label="基本信息">
            ...
            <el-form-item label="所属类目" prop="categoryid" v-show="qtisshow || rxisshow">
              <el-select v-model="dataForm.categoryid" class="filter-item" clearable placeholder="选择所属类目">
                <el-option
            ...
            <el-form-item label="商品简介" prop="introduction">
              <el-input v-model="dataForm.introduction" placeholder="商品简介"></el-input>
            </el-form-item>
            <el-form-item label="商品图片" prop="images">
              <el-button type="primary" @click="selectOssHandle()">商品图片<i class="el-icon-upload el-icon--right"></i></el-button>
            </el-form-item>
            ...
            <el-form-item label="积分值" prop="jifen" v-show="jfisshow">
              <el-input-number v-model="dataForm.jifen" :min="0" :max="999999999"  placeholder="积分值"></el-input-number>
            </el-form-item>
            <el-form-item label="商品单价(元)" prop="price" v-show="rxisshow || qtisshow">
              <el-input v-model="dataForm.price" placeholder="商品单价(元)"></el-input>
            </el-form-item>
            <el-form-item label="商品详情" prop="content">
              <ueditor v-model="dataForm.content"></ueditor>
            </el-form-item>
          <el-form-item label="购买人上级获得佣金" prop="gsyongjin" v-show="rxisshow">
            <el-input v-model="dataForm.gsyongjin" placeholder="购买人上级获得佣金"></el-input>
          </el-form-item>
          <el-form-item label="购买人获得总积分" prop="gjifen" v-show="rxisshow">
            <el-input-number v-model="dataForm.gjifen" :min="0" :max="999999999"  placeholder="购买人获得总积分"></el-input-number>
          </el-form-item>
          <el-form-item label="购买人每天返还总积分的千分比(‰)" prop="gmjifen" v-show="rxisshow">
            <el-input-number v-model="dataForm.gmjifen" :min="0" :max="999999999"  placeholder="购买人每天返还总积分的千分比(‰)"></el-input-number>
          </el-form-item>
          <el-form-item label="购买人上级获得积分" prop="gsjifen" v-show="rxisshow">
            <el-input-number v-model="dataForm.gsjifen" :min="0" :max="999999999"  placeholder="购买人上级获得积分"></el-input-number>
          </el-form-item>
          <el-form-item label="购买人上上级获得积分" prop="gssjifen" v-show="rxisshow">
            <el-input-number v-model="dataForm.gssjifen" :min="0" :max="999999999"  placeholder="购买人上上级获得积分"></el-input-number>
          </el-form-item>
          <el-form-item label="分享人获得积分" prop="fxjifen" v-show="rxisshow">
            <el-input-number v-model="dataForm.fxjifen" :min="0" :max="999999999"  placeholder="分享人获得积分"></el-input-number>
          </el-form-item>
        </el-tab-pane>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: `/dsh/goods/guige/${this.dataForm.id}`,
              method: 'get'
            }).then(({data}) => {
              if (data && data.code === 200) {
